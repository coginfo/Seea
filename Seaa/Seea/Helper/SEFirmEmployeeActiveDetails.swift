//
//  SEEmployeeDetailsTaskList.swift
//  Seaa
//
...
struct SEEmployeeDetailsTaskList : Codable {
    let key : String?
    let result_array : [EmployeeDetailsTaskList]?
    let message : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result_array = try values.decodeIfPresent([EmployeeDetailsTaskList].self, forKey: .result_array)
        message = try values.decodeIfPresent(String.self, forKey: .message)
    }
    
    
}
struct EmployeeDetailsTaskList : Codable {
    let task_id : String?
    let emp_id : String?
    let due_date : String?
